...
var christPopup = "Christ the Redeemer<br/><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Aerial_view_of_the_Statue_of_Christ_the_Redeemer.jpg/256px-Aerial_view_of_the_Statue_of_Christ_the_Redeemer.jpg' alt='great wall wiki' width='150px'/>";
...
var tajPopup = "Taj Majal<br/><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Taj-Mahal.jpg/256px-Taj-Mahal.jpg' alt='taj majal wiki' width='150px'/>";
...
//// add event listener click events to show lat long on the map
...
// make ISS marker with a custom icon
  var issIcon = L.icon({
...
//call ISS real time data URL
  var api_url = 'https://api.wheretheiss.at/v1/satellites/25544';

  var firstTime = true;

//update lat long based on the updated reading everytime
  async function getISS() {
    var response = await fetch(api_url);
    var data = await response.json();
    var { latitude, longitude } = data;

//chhange the marker location based on the updated reading but keep the map view in default center
